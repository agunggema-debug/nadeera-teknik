...
export const AREAS = ["Kota Bandung", "Ciparay", "Rancaekek", "Maju Kencana", "Cileunyi", "Jatinangor", "Soreang", "Katapang", "Margahayu", "Buah Batu", "Cimahi", "Ujung Berung", "Antapani", "Cibiru", "Baleendah", "Dayeuhkolot"];
